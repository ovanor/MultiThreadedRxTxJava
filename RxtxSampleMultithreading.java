...
/*
 *  Its making use of serial port interface provided balancer instrument.
*  
...
public class BalancerSerialCommunicator {

       private static Logger log = LoggerFactory.getLogger(BalancerSerialCommunicator.class);
